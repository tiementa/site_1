...
// register pranayama_yoga_Recent_Post widget
function pranayama_yoga_register_recent_post_widget() {
    register_widget( 'pranayama_yoga_Recent_Post' );
}
add_action( 'widgets_init', 'pranayama_yoga_register_recent_post_widget' );
 
 /**
 * Adds pranayama_yoga_Recent_Post widget.
 */
class pranayama_yoga_Recent_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'pranayama_yoga_recent_post', // Base ID
			__( 'RARA: Recent Post', 'pranayama-yoga' ), // Name
			array( 'description' => __( 'A Recent Post Widget', 'pranayama-yoga' ), ) // Args
		);
	}
...
} // class pranayama_yoga_Recent_Post 