...
// register pranayama_yoga_Popular_Post widget
function pranayama_yoga_register_popular_post_widget() {
    register_widget( 'pranayama_yoga_Popular_Post' );
}
add_action( 'widgets_init', 'pranayama_yoga_register_popular_post_widget' );
 
 /**
 * Adds pranayama_yoga_Popular_Post widget.
 */
class pranayama_yoga_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'pranayama_yoga_popular_post', // Base ID
			__( 'RARA: Popular Post', 'pranayama-yoga' ), // Name
			array( 'description' => __( 'A Popular Post Widget', 'pranayama-yoga' ), ) // Args
		);
	}
                        ...
                        <?php if( $show_thumb ){ ?>
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                ...
                                if ( has_post_thumbnail() ){
                                    the_post_thumbnail( 'pranayama-yoga-widgets-thumb' ); 
                                }else{ 
                                    pranayama_yoga_get_fallback_svg( 'pranayama-yoga-widgets-thumb' );
                                } 
                                ?>
                            </a>
                        <?php } ?>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'pranayama-yoga' ); ?></label> 
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
        
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'num_post' ) ); ?>"><?php esc_html_e( 'Number of Posts', 'pranayama-yoga' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_thumbnail' ) ); ?>"><?php esc_html_e( 'Show Post Thumbnail', 'pranayama-yoga' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_postdate' ) ); ?>"><?php esc_html_e( 'Show Post Date', 'pranayama-yoga' ); ?></label>
		</p>
		<?php 
	}
...
} // class pranayama_yoga_Popular_Post 